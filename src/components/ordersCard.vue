...
<template>
  <div class="order rounded-2xl shadow-md p-5 w-[31%] bg-white m-2 relative">
    ...
    <div class="element flex m-1 text-lg">
      ...
      <p class="mx-1"><span class="font-bold text-[#133B5D]">Price: </span> {{ order.price }} EGP</p>
    </div>
    ...
    <div class="element flex m-1 text-lg">
      ...
      <p class="mx-1"><span class="font-bold text-[#133B5D]">Date: </span>{{ order.date }}</p>
    </div>
    ...
    <div class="element flex m-1 text-lg">
      ...
      <p class="mx-1"><span class="font-bold text-[#133B5D]">Time: </span>{{ order.time }}</p>
    </div>
    ...
    <div class="element flex m-1 text-lg">
      ...
      <p class="mx-1"><span class="font-bold text-[#133B5D]">Client: </span> {{ order.customer }}</p>
    </div>
