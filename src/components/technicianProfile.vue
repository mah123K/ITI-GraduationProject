...
<template>
  <div class="technichainProfile my-20 w-[80%] mx-auto flex justify-between">
    ...
    <div class="card w-[35%] bg-secondry-color rounded-2xl">
      <div class="imgContainer flex flex-col items-center justify-center ">
        <img src="../images/Ellipse 56.png" class="mt-3 w-[200px]" alt="">
      ...
      <div class="dataContainer flex items-center justify-between m-6 text-[18px] font-semibold">
        <div class="dataKey">
          <ul>
            ...
            <li class="flex m-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 584 512" class="w-6 h-6" >
                <path fill="#5984c6" d="M256 0a256 256 0 1 1 0 512 256 256 0 1 1 0-512zM232 120l0 136c0 8 4 15.5 10.7 20l96 64c11 7.4 25.9 4.4 33.3-6.7s4.4-25.9-6.7-33.3L280 243.2 280 120c0-13.3-10.7-24-24-24s-24 10.7-24 24z"/>
              </svg>
              Response time
            </li>
            <li class="flex m-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 384 512" class="w-6 h-6" >
                <path fill="#5984c6" d="M249.9 66.8c10.4-14.3 7.2-34.3-7.1-44.7s-34.3-7.2-44.7 7.1l-106 145.7-37.5-37.5c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l64 64c6.6 6.6 15.8 10 25.1 9.3s17.9-5.5 23.4-13.1l128-176zm128 136c10.4-14.3 7.2-34.3-7.1-44.7s-34.3-7.2-44.7 7.1l-170 233.7-69.5-69.5c-12.5-12.5-32.8-12.5-45.3 0s-12.5 32.8 0 45.3l96 96c6.6 6.6 15.8 10 25.1 9.3s17.9-5.5 23.4-13.1l192-264z"/>              
              </svg>
              Orders Completed
            </li>
          </ul>
        ...
        <div class="dataValue">
          <ul>
            <li class="m-2">Dokki,Giza</li>
            <li class="m-2">Aug 2021</li>
    ...
    <div class="descreption w-[60%] flex flex-col ">
      <h1 class="font-bold text-5xl text-accent-color text-center mb-10">Services</h1>
      ...
      <div class="cardsContainer flex justify-around flex-wrap">
        ...
        <div class="serviceCard rounded-2xl shadow-lg text-center p-6 bg-[#f7f7f7] w-[30%] flex flex-col items-center my-5">
          ...
          <button @click="openPopup()" class="bg-accent-color text-white px-3  rounded-lg text- font-semibold hover:bg-[#4a74b3] transition cursor-pointer">
            Enter details
          </button>
        </div>
        ...
        <div class="serviceCard rounded-2xl shadow-lg text-center p-6 bg-[#f7f7f7] w-[30%] flex flex-col items-center my-5">
          ...
          <button @click="openPopup('fix tap leak', '150 EGP')" class="bg-accent-color text-white px-3  rounded-lg text- font-semibold hover:bg-[#4a74b3] transition cursor-pointer">
            Order
          </button>
        </div>
        ...
        <div class="serviceCard rounded-2xl shadow-lg text-center p-6 bg-[#f7f7f7] w-[30%] flex flex-col items-center my-5">
          ...
          <button @click="openPopup('fix shower', '250 EGP')" class="bg-accent-color text-white px-3  rounded-lg text- font-semibold hover:bg-[#4a74b3] transition cursor-pointer">
            Order
          </button>
        </div>
        ...
        <div class="serviceCard rounded-2xl shadow-lg text-center p-6 bg-[#f7f7f7] w-[30%] flex flex-col items-center my-5">
          ...
          <button @click="openPopup('install water filter', '200 EGP')" class="bg-accent-color text-white px-3  rounded-lg text- font-semibold hover:bg-[#4a74b3] transition cursor-pointer">
            Order
          </button>
        </div>
  ...
  <div v-if="showPopup" class="orderDetails fixed inset-0 bg-[#00000059] flex justify-center items-center z-50" @click.self="closePopup">
    <div class="bg-white rounded-2xl p-8 w-[80%] text-center shadow-2xl relative">
      <h2 class="text-2xl font-semibold mb-4 text-accent-color">Order Details</h2>
      ...
      <div class="subContainer flex justify-center">
        <div class="orderDetails w-[50%]">
          <div class="flex flex-col items-start mb-4">
            ...
            >
              ...
              >
                <path fill="#fff" d="M144 480c-79.5 0-144-64.5-144-144 0-63.4 41-117.2 97.9-136.5-1.3-7.7-1.9-15.5-1.9-23.5 0-79.5 64.5-144 144-144 55.4 0 103.5 31.3 127.6 77.1 14.2-8.3 30.8-13.1 48.4-13.1 53 0 96 43 96 96 0 15.7-3.8 30.6-10.5 43.7 44 20.3 74.5 64.7 74.5 116.3 0 70.7-57.3 128-128 128l-304 0zM305 191c-9.4-9.4-24.6-9.4-33.9 0l-72 72c-9.4 9.4-9.4 24.6 0 33.9s24.6 9.4 33.9 0l31-31 0 102.1c0 13.3 10.7 24 24 24s24-10.7 24-24l0-102.1 31 31c9.4 9.4 24.6 9.4 33.9 0s9.4-24.6 0-33.9l-72-72z"/>
              </svg>
        ...
        <div class="orderTime w-[50%] flex flex-col items-center">
          ...
          <!-- Select time -->
          <label class="font-medium mb-1 text-accent-color">Select Time:</label>
          <select
          ...
          <div v-if="selectedDay && selectedTime" class="mt-6 text-gray-700 text-center">
            <p>
              You selected:
              <span class="font-semibold text-accent-color">{{ selectedDay }}</span><br />
              at
  ...
  <div class="WorkGallery flex flex-col items-center justify-center w-[80%] mx-auto">
