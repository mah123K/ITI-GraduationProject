<template>
    ...
    <div class="grid grid-cols-2 gap-10 mt-10 mb-10 md:grid-cols-4">
        ...
        <div class="card cursor-pointer bg-[#DAECF6] image-full w-45 rounded-2xl shadow-sm h-55 hover:scale-105 transition duration-300">
        <div>
        <img src="https://res.cloudinary.com/dlrgf0myy/image/upload/v1760695818/image__1_-removebg-preview_spqrzh.png" class=""/>
        <span class="text-center  block text-[#5984C6] text-xl font-medium">Plumbing</span>
        </div>
    </div>
    <div class=" card cursor-pointer bg-[#DAECF6] image-full w-45 rounded-2xl shadow-sm h-55 hover:scale-105 transition duration-300">
        
        <div>
          <img src="https://res.cloudinary.com/dlrgf0myy/image/upload/v1760696039/image__2_-removebg-preview_qlbzwa.png" class=" w-full"/>
        <span class="text-center  block text-[#5984C6] text-xl font-medium">Finishing</span>
        </div>
    </div>
    <div class=" card cursor-pointer bg-[#DAECF6] image-full w-45 rounded-2xl shadow-sm h-55 hover:scale-105 transition duration-300">
        
        <div>
          <img src="https://res.cloudinary.com/dlrgf0myy/image/upload/v1760696039/image__3_-removebg-preview_ko98nb.png" class=""/>
        <span class="text-center  block text-[#5984C6] text-xl font-medium">Electrical</span>
        </div>
    </div>
    <div class=" card  cursor-pointer bg-[#DAECF6] image-full w-45 rounded-2xl shadow-sm h-55 hover:scale-105 transition duration-300">
        
        <div>
          <img src="https://res.cloudinary.com/dlrgf0myy/image/upload/v1760696039/image__4_-removebg-preview_ihc9at.png" class=""/>
        <span class="text-center  block text-[#5984C6] text-xl font-medium">Carpentry</span>
        </div>
    </div>
        </div>
    </div>
    <!--offer cards-->
    <div>
        <h2 class="text-[#5984C6] text-center text-4xl font-medium mb-6">Exclusive Offers</h2>
    </div>
    ...
    <div class="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-3">
        <div class="card bg-secondary-blue rounded-xl h-fit w-70 shadow-sm">
            <div class="offer absolute "><img src="https://res.cloudinary.com/dlrgf0myy/image/upload/v1760703911/image__8_-removebg-preview_oymppq.png" class="w-15 rounded-b-full " alt=""></div>
  ...
  <div class="card-body mt-2 items-center  text-center">
    ...
    <div class="card-actions pb-3">
      <button class="btn mt-2 text-white rounded-sm p-1.5 cursor-pointer  bg-[#5984C6]">Claim offer</button>
    </div>
  </div>
</div>
...
<div class="card bg-secondary-blue rounded-2xl w-70  shadow-sm">
  ...
  <div class="card-body mt-2 items-center  text-center">
    ...
    <!--Why choose us-->
    <div>
        <h2 class="text-[#5984C6] text-center text-4xl font-medium mb-6 mt-10">Why Choose US?</h2>
    </div>
    <div class="flex justify-center">
        <div class="grid grid-cols-1 md:grid-cols-2">
            <div class="card w-70 rounded-2xl h-full">
                    <img
                    src="https://res.cloudinary.com/dlrgf0myy/image/upload/v1760705618/image_10_vvoxvo.jpg" class="hidden h-92 md:block"
                    alt="Movie" />
            </div>
            <ul class=" ">            
            <li class="row flex flex-row justify-between pb-15">
                ...
                <div class="w-80">We serve over 60,000 happy customers and they continue to order regularly.</div>
                </div>
            </li>
            
            <li class="row flex flex-row justify-between pb-15">
                <div class="text-4xl font-thin pr-5"><i class="fa-solid fa-people-group text-[#5984C6] w-10"></i></div>
                <div class="list-col-grow">
                <div class="w-80">flexible prices, choose the price suitable for you and negotiate </div>
                </div>
            </li>
            
            <li class="row flex flex-row justify-between pb-15">
                <div class="text-4xl font-thin pr-5"><i class="fa-solid fa-address-card text-[#5984C6] w-10"></i></div>
                <div class="list-col-grow">
                <div class="w-80">All workers and technicians are contracted with us and all their data is fully available.</div>
                </div>
            </li>

             <li class="row flex flex-row justify-between pb-15">
                <div class="text-4xl font-thin pr-5"><i class="fa-solid fa-headphones text-[#5984C6] w-10"></i></div>
                <div class="list-col-grow">
                <div class="w-80">continues follow-up during and until the completion of the order implementation.</div>
                </div>
            </li>
    ...
    <!-- العنوان -->
    <h2 class="text-[#5984C6] text-center text-4xl font-medium mt-5">
    ...
    >
      ...
      >
        ...
        >
          ...
          <!--our work--> 
          <h2 class="text-[#5984C6] hidden md:block mb-5 text-center text-4xl font-medium mt-5">
      Our Work
    </h2>
          <div class="flex justify-center">
            <div class="md:grid md:grid-cols-9 grid-cols-3 hidden grid-rows-2 md:w-2xl">
                  <div
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-5">
    ...
    <!-- Card 1 -->
    <div class="flex cursor-pointer items-center gap-4 bg-white shadow-md border border-gray-200 rounded-2xl px-6 py-4 hover:shadow-lg transition-all duration-300 w-64">
      ...
      <div>
        ...
        <span class="text-gray-500 text-sm">+2025895623</span>
      </div>
    </div>

    <!-- Card 2 -->
    <div class="flex cursor-pointer items-center gap-4 bg-white shadow-md border border-gray-200 rounded-2xl px-6 py-4 hover:shadow-lg transition-all duration-300 w-64">
      <div class="flex items-center justify-center w-12 h-12 bg-green-100 text-green-600 rounded-full text-xl">
        <i class="fa-solid fa-envelope"></i>
      </div>
      <div>
        <h3 class="text-lg font-semibold text-gray-800">Email</h3>
        <span class="text-gray-500 text-sm">tashtebaty12@gmail.com</span>
      </div>
    </div>

    <!-- Card 3 -->
    <div class="flex cursor-pointer items-center gap-4 bg-white shadow-md border border-gray-200 rounded-2xl px-6 py-4 hover:shadow-lg transition-all duration-300 w-64">
      <div class="flex items-center justify-center w-12 h-12 bg-yellow-100 text-yellow-600 rounded-full text-xl">
        <i class="fa-solid fa-location-dot"></i>
      </div>
      <div>
        <h3 class="text-lg font-semibold text-gray-800">Address</h3>
        <span class="text-gray-500 text-sm">XYZ Street</span>
      </div>
    </div>
