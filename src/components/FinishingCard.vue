<template>
  <div>
    ...
    >
      <img
        src="../images/finish company.png"
        alt="Profile photo"
        class="absolute w-full h-[70%] mt-[-60px] object-contain"
      />
      ...
      >
        <img src="../images/finishcompanyIcon.png" alt="" class="transition-all duration-500 p-2">
      </div>
