<script setup>
// import contactHeader from '@/assets/imges/Rectangle 55.png'
...
<template>
  <div
    class="contact-page flex flex-col items-center text-center font-sans pt-18"
  >
    <!-- Header Image -->
    ...
    <section class="my-2 px-6 md:px-20 w-full max-w-5xl">
      ...
      <p class="text-gray-600 mb-8">We are here to help you with your issue</p>

      <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div
          class="rounded-2xl shadow-lg p-6 flex items-center justify-between h-30 bg-[#f5f5f5] transition-transform duration-200 hover:scale-102" 
        >
          <svg
          ...
          <div class="flex flex-col text-left ">
            ...
            <p class="text-gray-600 mt-1">Basharim Center, Giza</p>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex flex-col text-left">
            ...
            <p class="text-gray-600 mt-1">‪+201234567890‬</p>
          </div>
        </div>
        ...
        >
          ...
          <div class="flex flex-col text-left ">
            ...
            <p class="text-gray-600 mt-1">example@gmail.com</p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="my-8 w-full max-w-3xl px-6">
      ...
      <form class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
        <input
          type="text"
          placeholder="Name"
          class="rounded-lg p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#5984C6]"
        />
        <input
          type="email"
        ...
        <textarea
          ...
          rows="5"
          class="md:col-span-2 rounded-lg p-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#5984C6]"
        ></textarea>

        <div class="md:col-span-2 flex justify-center">
          <button
            type="submit"
            class="w-30 bg-[#5984C6] text-white text-[22px] py-3 rounded-[20px] hover:bg-[#4b72ac] transition-all"
          >
            Submit
          </button>
        </div>
