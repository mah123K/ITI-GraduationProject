...
    meta: { requiresTechnician: true },
    // 1. تم حذف مصفوفة "children" من هنا
  },

  // 2. تم إضافة صفحة الدردشة كصفحة مستقلة
  {
    path: "/technician-chat",
    name: "TechnicianChat", // هذا هو الاسم الذي يستخدمه الزر
    component: ChatPage,     // هذا هو المكون الذي سيتم فتحه
    meta: { requiresTechnician: true }
  },
